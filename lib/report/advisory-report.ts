...
const CALCULATOR_META: Record<string, CalculatorMeta> = {
  ...
  "wealth-kosten": {
    title: "Wirkung laufender Kosten",
    eyebrow: "Kostenvergleich",
    meaning: "Der Vergleich zeigt, wie laufende Produktkosten das langfristige Vermögen beeinflussen.",
    source: "Vermögensentwicklung vor und nach laufenden Kosten",
  },
  "wealth-ziel": {
    title: "Ihr persönliches Sparziel",
    eyebrow: "Sparzielrechnung",
    meaning: "Die erforderliche Sparrate verbindet das gewünschte Zielvermögen mit dem verfügbaren Zeitraum.",
    source: "Zielwertrechnung mit Renditeannahme",
  },
  "wealth-3a": {
