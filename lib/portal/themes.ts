...
export const THEME_TOOLS: Record<string, ThemeTool> = {
  ...
  steuer3a: { id: "steuer3a", title: "Steuereffekte 3a", icon: "calc", desc: "Steuerersparnis mit aktuellen ESTV-Daten in Franken berechnen.", href: "/rechner/steuern?tool=3a" },
  ...
  steuer: { id: "steuer", title: "Schweizer Steuerrechner", icon: "calc", desc: "Einkommen, Kapitalbezug und Immobilienverkauf nach Steuerort prüfen.", href: "/rechner/steuern" },
